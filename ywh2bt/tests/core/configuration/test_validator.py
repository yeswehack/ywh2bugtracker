...
class TestValidator(unittest.TestCase):
    ...
    def test_invalid_protocol(self) -> None:
        self.when_validate(url="ssh://example.com",).then_assert_has_error_type(
            error_type=ValidatorError,
        )

    def test_invalid_none_url(self) -> None:
        self.when_validate(url=None,).then_assert_has_error_type(
            error_type=TypeError,
        )

    def test_invalid_empty_url(self) -> None:
        self.when_validate(url="",).then_assert_has_error_type(
            error_type=ValidatorError,
        )
